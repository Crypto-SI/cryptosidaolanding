...
import { ArrowRight, FileText, Scaling, Users, Vote, ChevronDown, ChevronUp } from "lucide-react";
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="flex items-center justify-center gap-4">
              <h2 className="text-3xl font-headline tracking-tighter sm:text-5xl">CryptoSI Improvement Proposals (CIPs)</h2>
