...
import { ArrowRight, MessageSquare, Twitter, ChevronDown, ChevronUp } from "lucide-react";
        ...
        {isExpanded && (
            <>
                ...
                <div className="grid gap-1 text-center">
                    ...
                    <div className="mt-4">
                        <Card className="bg-secondary transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary/40">
                            <CardHeader>
                ...
                <div className="grid gap-1 text-center">
                    ...
                    <Button asChild variant="outline">
                        <Link href="https://twitter.com/Crypto_SI" target="_blank" rel="noopener noreferrer">
